...
2. Edit the file `voting-committees.json` by adding your committee details to the list. You will need to choose a name for your committee and enter the Github ID and Ethereum address for all members of your committee. Ethereum addresses will be used to distribute the voting committee earnings at the beginning of each month. The `id` value should be a +1 increment of the biggest committee id already in the file. Also, create a new file in the `landing-pages` folder called `{your-voting-committee-id}.md` to present your committee members and explain why stakers should delegate to your committee. This will serve as the official landing page for your committee.
